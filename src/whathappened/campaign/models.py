...
class Handout(BaseModel):
    ...
    status: Mapped[HandoutStatus] = mapped_column(
        Enum(HandoutStatus), default=HandoutStatus.draft, nullable=True
    )
    ...
    group_id: Mapped[int] = mapped_column(
        Integer, ForeignKey("campaign_handout_group.id"), nullable=True
    )

    group: Mapped[HandoutGroup] = relationship("HandoutGroup")
...
class NPC(BaseModel):
    ...
    character_id: Mapped[int] = mapped_column(
        Integer, ForeignKey("charactersheet.id"), nullable=False
    )
...
class Message(BaseModel):
    ...
    from_id: Mapped[int] = mapped_column(
        Integer, ForeignKey("user_profile.id"), nullable=False
    )
