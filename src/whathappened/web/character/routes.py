...
from whathappened.core.models import Invite, LogEntry
...
from ...core.sheets.mechanics.coc7e.convert import convert_from_dholes
# from .tftl import *
...
def create(chartype: str):
    ...
    logger.debug("Using %s as creation template", template)
